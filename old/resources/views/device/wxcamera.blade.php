...
<body>
        ...
        <div class="mt">
				...
				<div class="preview" >
					<center><image id="photo" src="http://mp1.ai-thinker.com/Modules/A6C/a6c_{{$device_id}}_{{$user->id}}_{{$image_id}}.jpg" border=2 width=160 height=160 /></center>
				</div>
    ...
    <script>
		  ...
		  function query()
		  {
            ...
            success: function (response) 
				{ 
					...
					{
						document.getElementById("photo").src="http://mp1.ai-thinker.com/Modules/A6C/Camera/a6c_"+data.image_name;		
        ...
        $(document).ready(function(){
			...
			//	document.getElementById("photo").height=photo.naturalHeight;					  
				...
				{  
					imgs.push('http://mp1.ai-thinker.com/Modules/A6C/a6c_{{$device_id}}_{{$user->id}}_'+(g_imageId-i)+'.jpg');
                  //  alert(imgs[i]);					
				}		 		  
			 ...
			 function ajax(){                                
                $.ajax({
                    ...
                    success: function (response) {
						...
						{
							document.getElementById("photo").src="http://mp1.ai-thinker.com/Modules/A6C/a6c_{{$device_id}}_{{$user->id}}_"+g_imageId;		
							document.getElementById("capture").innerHTML="远程拍照";
							g_CanCapture=1;	
							g_count=0;
